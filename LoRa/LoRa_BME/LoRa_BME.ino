...
#define NORMALINTERVAL  124   // 15 minutes (normal)
...
static const u4_t DEVADDR = 0x0000000; // LoRaWAN end-device address (DevAddr)
...
void do_send(osjob_t* j)
{
    ...
    else 
    {
        ...
        float batt = (int)(readVcc() / 100);  // readVCC returns  mVolt need just 100mVolt steps
    ...
    lpp.addRelativeHumidity(2, humidity);   // channel 2, pressure
    lpp.addAnalogInput(3, batt);
